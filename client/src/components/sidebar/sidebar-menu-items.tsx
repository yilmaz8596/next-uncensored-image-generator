      ...
      {items.map((item) => (
        <SidebarMenuItem key={item.title}>
          <SidebarMenuButton
            ...
            className={cn(
              "group/item hover:bg-primary/10 hover:text-foreground relative h-10 w-full justify-start rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200",
